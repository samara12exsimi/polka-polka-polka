...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"OPT-TLLN8X2_OPT-5XZ9T",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__v",
      ...
      "function":"__exs",
      "vtp_measurementId":"M7ZXhVGtRG-F0a90O1ltyg",
      "vtp_sections":["list",3]
    },{
      "vtp_experimentKey":"OPT-TLLN8X2_OPT-5XZ9T",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18388,"M7ZXhVGtRG-F0a90O1ltyg",18481]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-223724-2"
    },{
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_OPT-TLLN8X2_OPT-5XZ9T:0",
      "vtp_contextIndex":0,
      "tag_id":49
    },{
      "function":"__etx",
      "vtp_selector":"button.e-btn--margin_bottom",
      "vtp_identifier":"button.e-btn--margin_bottom",
      "vtp_text":"Sprawdź dostępność i zarezerwuj",
      "vtp_childIndex":0,
      "vtp_mode":"REPLACE",
      "tag_id":51
    },{
  ...
  "rules":[
    [["if",0],["add",0]],
    [["if",1],["add",0]],
    [["if",0,3,5],["unless",2,4],["add",1]],
    [["if",0,3,4],["unless",2,9],["add",2]],
    [["if",0,3,4,10],["unless",2],["add",3]],
    [["if",0,3,4,11],["unless",2],["add",4]],
    [["if",0,3,4,12],["unless",2],["add",5]],
    [["if",6],["block",1,2,3,4,5]],
    [["if",7],["block",1,2,3,4,5]],
    [["if",8],["block",1,2,3,4,5]]]
},
"runtime":[]
...
var zj=function(){try{var a,b;var c=D[Pe()],d="gtm4";""==d&&(d="t0");b="ga";try{var e=c&&c.getByName&&c.getByName(d);if(e){0===d.indexOf("gtag_")&&(b="gtag");e.get("&gtm")&&(b="gtm");for(var f in c)if(c.hasOwnProperty(f)){var h=c[f];if("l"!==f&&"answer"!==f&&"number"===typeof h){var k=qj-h;1E5>k&&0<k&&(a=k)}}}}catch(A){console.log("[tick.ga] - "+I.s+": exception: "+A)}
...
var Ol=function(a,b,c){function d(){f||(f=!0,!0!==Ll&&(Ll=!1),Ml(c),jj(kj(),e))}Ej=a;var e="GTM-TLLN8X2_"+b,f=!1;lj(e);D.google_optimize=D.google_optimize||{};var h=D.google_optimize;h["GTM-TLLN8X2"]=h["GTM-TLLN8X2"]||{};h["GTM-TLLN8X2"].optimize_dyn=function(l){l.split(",").forEach(function(m){Nl[m]=!0});Ll=!0;d()};kc(a,void 0,d);var k=kj();D.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},Ml=function(a){if(void 0!==Pl){var b=Pl-Ql,c,d;Ll?c=Ga()-Pl:d=Ga()-Pl;Fj({uh:b,Pg:c,Ng:d})}Nl.optimize_ready=
!0;Kj({event:"opt.dyn"});Kj({event:"opt.js"});if(a&&0<a.length){var e={};kj().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&Kj({event:f})})}H(function(){Qe("_"+I.s)})},kj=function(){return D["dataLayer"]},Rl=function(a,b,c,d,e,f,h){function k(p,t){t&&(r+="&"+p+"="+encodeURIComponent(t))}Ql=Ga();if(a||b||c){var l=void 0;if(b){var m=$g().aw;m&&(l=m[0])}if(f&&(a||c||l)){var q=1,r,u="GTM-TLLN8X2_"+q++;lj(u);Hl[d]=!0;Il(d,function(p){Pl=Ga();a||b?(r="?id=GTM-TLLN8X2",
...
Y.a.etx=["google"],function(){(function(a){Y.__etx=a;Y.__etx.b="etx";Y.__etx.g=!0;Y.__etx.priorityOverride=0})(function(a){var b=a.vtp_selector,c=a.vtp_mode,d=a.vtp_childIndex,e=a.vtp_text,f=a.vtp_identifier;wc?fm?im({I:b,T:!0,F:b==f?1:null},function(h){if(h){var k;var l=c;if(Qk(h))k=7;else{l=(l||"").toLowerCase();var m;if("replace"==l)m=fl(h,d,e);else{var q=h,r,u=null,p=null;r=(l||"").toLowerCase();"before"==r?(p=q,q=q.parentNode):"after"==r?(u=q,q=q.parentNode):0<q.childNodes.length&&(0>d?p=q.childNodes[0]:
d>=q.childNodes.length?u=q.childNodes[q.childNodes.length-1]:"insert"==r?p=q.childNodes[d]:"append"==r&&(u=q.childNodes[d]));m=q?gl(e,q,u,p):1}k=m}return k}},!1)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure():a.vtp_gtmOnFailure():a.vtp_gtmOnFailure()})}();
